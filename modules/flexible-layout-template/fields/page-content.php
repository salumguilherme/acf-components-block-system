	...
	class Page_Content {
		...
		public static function get_base_layouts() {
			...
			return [
				...
				'layout_7a0a99fd3f22b' => [
					'key' => 'layout_7a0a99fd3f22b',
					'label' => 'Icon Leaders',
					'name' => 'icon_leaders',
					'display' => 'row',
					'min' => '',
